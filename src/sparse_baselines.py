"""Sparse linear baselines shared by experiment scripts (tasks 12.1–12.2).

Fits :class:`BaselineFeatureExtractor` on *train*, then evaluates
:class:`sklearn.linear_model.LogisticRegression` and
:class:`sklearn.svm.LinearSVC` on **train**, **validation**, and **test** splits
with the same metric contract as :func:`src.evaluate.evaluate_labels`.
"""
